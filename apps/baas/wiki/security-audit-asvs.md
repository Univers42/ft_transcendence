...
> attestation. Formal SOC2 Type 2 / HIPAA / ISO are **deferred by decision (D4)**.
...
**Explicitly out of scope (decision D4):** formal **SOC2 Type 2 / HIPAA / ISO 27001**
attestations. This document is the posture that makes those a checklist later; the
paid, calendar-bound certification process is deferred.
